...
See the [public roadmap](roadmap) for the post-GA OSS line (per-key hydration routing, connector
parallelism) and the [commercial line](roadmap#open-source-vs-enterprise) (cold-tier / tiered storage,
