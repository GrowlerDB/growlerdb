...
/**
 * Trino plugin entry point: registers the GrowlerDB connector, whose only surface is the
 ...
 * Loaded by Trino from {@code etc/catalog/growlerdb.properties} (connector.name=growlerdb).
 */
